...
def getFromDict(dataDict, *mapList):
    ...
    for arg in mapList:
        for mapper in arg:
            ...
            with open(
                    '/Users/edwari/Documents/Exercises/Python/json/csv-files/i_{0}.csv'.format(no_ext),
                    'a') as out:
...
def process_file():
    ...
    return data_202, stored_paths

#Function to append data to keys

if __name__ == "__main__":
    json_data,paths=process_file()
    getFromDict(json_data, paths)
